...
if __name__ == '__main__':
    ...
    cam_dir = './cam_result/test_result_right/cam_img_%s' % args.dataset
    label_dir = './cam_result/test_result_right/cam_labels_%s' % args.dataset
    ...
    for batch_idx, (x, y) in enumerate(test_loader):
        ...
        if (np.array(y) == idx and np.array(y) == 8):
